<template>
    <div class="activuty-box" v-on:click="activityClickEvent">
        <div :style="{backgroundImage: 'url(' + imgSrc + ')'}" class="activity-img"></div>
...
<script>
    export default {
        ...
        methods: {
            ...
            activityClickEvent() {
                this.$emit('activity-click-event', {
                    id:this._props.id,
                    imgSrc:this._props.imgSrc,
